...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Health Care System | 500</title>
    ...
    <body class="page-500-full-page">
        <div class="page-500 error">
            <img src="{{ asset('custom/error.png') }}" alt="500">
            <h1 class="number font-red">500</h1>
            <div class="details">
                <h3>Laman tidak tersedia.</h3>
                <p>Silahkan ikuti tautan <a href="{{ url('/home') }}"> berikut </a> untuk kembali.</p>
                <p>{{ $e->getMessage() }}</p>
            </div>
        </div>
        <!--[if lt IE 9]>
